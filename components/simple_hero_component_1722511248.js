...
*/
Vue.component("simple_hero_component_1722511248", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl shadow-xl p-8">
                    
                    <div id="hero-title-container-text" class="flex">
                        <h1 id="hero-title" class="flex-1 max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-white">Uncover Blockchain Insights</h1>
                    </div>

                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-pink-100 lg:mb-8 md:text-lg lg:text-xl">Powerful Analytics for the Decentralized World</p>
                    </div>
                ...
                <div id="hero-image-container" class="hidden lg:mt-0 lg:col-span-5 lg:flex items-center justify-center">
                    <img id="hero-image" src="./images/hero.png" alt="hero image" class="rounded-2xl shadow-2xl transform hover:scale-105 transition duration-300 ease-in-out">
                </div>
            </div>
        </section>            
    `,
